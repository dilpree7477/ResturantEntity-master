<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ContactDetails.aspx.cs" Inherits="ResturantEntity.ContactDetails" %>
                ...
                <div class="container resturant_contact_container">
                    <div class="row m-0 resturant_contact_row">
                        ...
                        <div class="col-sm-12 p-0 resturant_contact_form">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ResturantSiteConnectionString %>" DeleteCommand="DELETE FROM [Contact] WHERE [id] = @id" InsertCommand="INSERT INTO [Contact] ([Name], [Email], [Contact], [Message]) VALUES (@Name, @Email, @Contact, @Message)" SelectCommand="SELECT * FROM [Contact] ORDER BY [id] DESC" UpdateCommand="UPDATE [Contact] SET [Name] = @Name, [Email] = @Email, [Contact] = @Contact, [Message] = @Message WHERE [id] = @id">
                                <DeleteParameters>
